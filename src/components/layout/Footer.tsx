        ...
        <div className="flex flex-col items-center text-center gap-6">
          ...
          <div className="flex gap-3">
            <a href="https://instagram.com/cerveceriaburgos" target="_blank" rel="noopener noreferrer"
              className="p-2.5 bg-[#FBF5DD]/10 rounded-lg hover:bg-[#99120f] transition-colors" aria-label="Instagram">
              <InstagramIcon className="w-5 h-5" />
            </a>
            <a href="https://facebook.com/cerveceriaburgos" target="_blank" rel="noopener noreferrer"
              className="p-2.5 bg-[#FBF5DD]/10 rounded-lg hover:bg-[#99120f] transition-colors" aria-label="Facebook">
              <FacebookIcon className="w-5 h-5" />
            </a>
            <a href="https://wa.me/34625047070" target="_blank" rel="noopener noreferrer"
              className="p-2.5 bg-[#FBF5DD]/10 rounded-lg hover:bg-[#99120f] transition-colors" aria-label="WhatsApp">
