  ...
  return (
    <section id="contacto" className="py-24 bg-[#FBF5DD]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* About story + info cards */}
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 mb-20">
          <FadeIn direction="left" className="flex flex-col justify-center">
            <div className="space-y-4 text-[#A06029] text-lg leading-relaxed">
        ...
        <FadeIn delay={0.3} className="text-center">
          ...
          <div className="flex justify-center gap-4">
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 bg-white rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.06)] border border-[#151418]/5 hover:bg-[#99120f] hover:border-[#99120f] transition-colors group"
              whileHover={{ y: -3 }}
              whileTap={{ scale: 0.95 }}
            >
              <InstagramIcon className="w-5 h-5 text-[#151418] group-hover:text-[#FBF5DD]" />
            </motion.a>
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
            >
              <FacebookIcon className="w-5 h-5 text-[#151418] group-hover:text-[#FBF5DD]" />
            </motion.a>
            <motion.a
              ...
              aria-label="WhatsApp"
            >
              <svg className="w-5 h-5 text-[#151418] group-hover:text-[#FBF5DD]" fill="currentColor" viewBox="0 0 24 24">
